...
>[!NOTE]
>
>Se un test case non contiene un `rendition.*` e non definisce il file previsto `errorReason` all&#39;interno del `params.json` file, si presume che sia un caso di errore con qualsiasi `errorReason`.
